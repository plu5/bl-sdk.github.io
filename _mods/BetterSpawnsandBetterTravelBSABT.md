...
tagline: "Spawning and traveling like in BL3." # A short description of the mod itself.
description: "Spawning and traveling like in BL3." # This is set in order to keep the SEO proper
longDescription: "Ports back some qol features of BL3:\n- open the fast travel from anywhere\n- teleport in your vehicle from the map menu\n- spawn at the last triggered spawn station\n![yt](https://www.youtube.com/watch?v=pY17YkKkTqg)" # Description of what the mod can do
